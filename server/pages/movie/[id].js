...
function Movie({ result  }) {
    ...
    (_styles_Home_module_scss__WEBPACK_IMPORTED_MODULE_9___default());
            ...
            /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                ...
                children: [
                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("h1", {
                        children: result.title || result.original_title
                    }),
                    /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
...
async function getServerSideProps(context) {
    console.log(context);
    const response = await fetch(`https://api.themoviedb.org/3/movie/${context.query.id}?api_key=${"354ed36ed34f2ec7a18123256a906dd5"}&language=en-US&append_to_response=videos`);
...
var __webpack_exports__ = __webpack_require__.X(0, [730,664,675,177,938], () => (__webpack_exec__(6057)));
